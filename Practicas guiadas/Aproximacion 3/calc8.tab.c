...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_impresion = 22,                 /* impresion  */
  YYSYMBOL_expresion = 23,                 /* expresion  */
  YYSYMBOL_termino = 24,                   /* termino  */
...
{
       0,    77,    77,    77,    79,    79,    81,    81,    85,    86,
      89,    92,    96,    97,    98,    99,   100,   101,   102,   105,
     106,   107,   110,   111,   112
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'='", "'+'", "'-'", "'*'", "'/'", "SIGNO_UNARIO", "'\\n'", "'#'", "'('",
  "')'", "$accept", "axioma", "$@1", "$@2", "$@3", "r_expr", "asignacion",
  "impresion", "expresion", "termino", "operando", YY_NULLPTR
};
...
{
       3,   -25,    -4,    14,    14,     3,     3,     5,     1,    10,
      38,   -25,   -25,     3,   -25,   -25,   -25,   -25,   -25,    44,
      34,   -25,   -25,   -25,     3,     3,     3,     3,   -25,    44,
     -25,     3,     3,    11,    11,   -25,   -25,     3,   -25,   -25,
     -25,   -25
};
...
{
       0,    23,    22,     0,     0,     0,     0,     0,    17,    18,
       0,    12,    19,     0,    22,    20,    21,    17,    18,    11,
       0,     1,     4,     6,     0,     0,     0,     0,     2,    10,
      24,     8,     8,    13,    14,    15,    16,     8,     9,     5,
       7,     3
};
...
{
       8,    13,     9,    19,    20,    21,     1,     2,    40,     3,
       4,    29,    22,    41,     0,     5,     6,     1,    14,    26,
      27,    23,    33,    34,    35,    36,     7,     6,    15,    16,
       0,     8,     8,     9,     9,     0,     0,     8,     0,     9,
      24,    25,    26,    27,    24,    25,    26,    27,    30,    28,
      24,    25,    26,    27
};

static const yytype_int8 yycheck[] =
{
       0,     5,     0,     5,     6,     0,     3,     4,    32,     6,
       7,    13,    11,    37,    -1,    12,    13,     3,     4,     8,
       9,    11,    24,    25,    26,    27,     0,    13,     3,     4,
...
static const yytype_int8 yystos[] =
{
      ...
      23,    24,    25,     5,     4,    25,    25,    21,    22,    23,
      23,     0,    11,    11,     6,     7,     8,     9,    11,    23,
      14,    18,    19,    23,    23,    23,    23,    17,    16,    20,
      20,    20
};
...
#line 77 "calc8.y"
                                                                { printf ("%s\n", (yyvsp[-1].cadena)) ; }
#line 1208 "calc8.tab.c"
    break;

  case 4: /* $@2: %empty  */
#line 79 "calc8.y"
                                                    { printf ("%s\n", (yyvsp[-1].cadena)) ; }
#line 1214 "calc8.tab.c"
    break;

  case 6: /* $@3: %empty  */
#line 81 "calc8.y"
                                                        { printf ("%s\n", (yyvsp[-1].cadena)) ; }
#line 1220 "calc8.tab.c"
    break;

  case 8: /* r_expr: %empty  */
#line 85 "calc8.y"
                                                                { ; }
#line 1226 "calc8.tab.c"
    break;

  case 9: /* r_expr: axioma  */
#line 86 "calc8.y"
                                                                    { ; }
#line 1232 "calc8.tab.c"
    break;

  case 10: /* asignacion: VARIABLE '=' expresion  */
#line 89 "calc8.y"
                                                        { sprintf(temp, "( setq %c %s )", (yyvsp[-2].indice), (yyvsp[0].cadena)); (yyval.cadena)=genera_cadena (temp); }
#line 1238 "calc8.tab.c"
    break;

  case 11: /* impresion: '#' expresion  */
#line 92 "calc8.y"
                                                            { sprintf(temp, "( print %s )", (yyvsp[0].cadena)); (yyval.cadena)=genera_cadena (temp); }
#line 1244 "calc8.tab.c"
    break;

  case 12: /* expresion: termino  */
#line 96 "calc8.y"
                                                                    { (yyval.cadena) = (yyvsp[0].cadena) ; }
#line 1250 "calc8.tab.c"
    break;

  case 13: /* expresion: expresion '+' expresion  */
#line 97 "calc8.y"
                                                            { sprintf(temp, "( + %s %s )", (yyvsp[-2].cadena), (yyvsp[0].cadena)); (yyval.cadena)=genera_cadena (temp); }
#line 1256 "calc8.tab.c"
    break;
